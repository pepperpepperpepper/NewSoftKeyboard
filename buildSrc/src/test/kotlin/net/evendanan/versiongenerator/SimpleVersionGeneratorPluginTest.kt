...
class SimpleVersionGeneratorPluginTest {
  ...
  fun testFactoryExistsInExtension() {
    ...
    verify(extensions)
        .create(
            eq("autoVersioning"), eq(SimpleVersionGeneratorPlugin.SimpleConfiguration::class.java))
  }
  ...
  fun testFailsIfEnvironmentVariableWasNotSet() {
    ...
    doReturn(SimpleVersionGeneratorPlugin.SimpleConfiguration())
        .`when`(extensions)
        .getByType(eq(SimpleVersionGeneratorPlugin.SimpleConfiguration::class.java))
  ...
  fun testTakesValueFromEnv() {
    ...
    val settings =
        SimpleVersionGeneratorPlugin.SimpleConfiguration().apply {
