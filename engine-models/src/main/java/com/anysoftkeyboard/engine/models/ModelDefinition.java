package com.anysoftkeyboard.engine.models;
...
/** Metadata describing an on-device language model package. */
@Keep
public final class ModelDefinition {
  ...
  @NonNull
  public static String serializeEngineType(@NonNull EngineType engineType) {
    switch (engineType) {
      case NGRAM:
        // Keep legacy value for on-device manifest/selection compatibility.
        return "presage_ngram";
      case NEURAL:
  ...
  @NonNull
  public static EngineType parseEngineType(@NonNull String value) {
    final String normalized = value.trim().toLowerCase(Locale.US);
    if (normalized.isEmpty() || "ngram".equals(normalized) || "presage_ngram".equals(normalized)) {
      return EngineType.NGRAM;
    }
    if ("neural".equals(normalized) || "onnx_transformer".equals(normalized)) {
  ...
  public JSONObject toJson() throws JSONException {
    ...
    object.put("engine", serializeEngineType(mEngineType));
  ...
  @NonNull
  public static ModelDefinition fromJson(JSONObject object) throws JSONException {
    ...
    final EngineType engineType = parseEngineType(engineRaw);
    final JSONArray filesArray = object.optJSONArray("files");
    if (filesArray == null || filesArray.length() == 0) {
      throw new JSONException("Model manifest missing files array");
    }

    final java.util.LinkedHashMap<String, FileRequirement> requirements =
    ...
    return new ModelDefinition(id, label, engineType, requirements);
  }

  @NonNull
  public static ModelDefinition createDefaultKenlmDefinition() {
  ...
  public static final class Builder {
    ...
    public Builder setOnnxFile(
        @NonNull String filename, @Nullable String sha256, @Nullable String assetPath) {
    ...
    public ModelDefinition build() {
      ...
      return new ModelDefinition(mId, label, mEngineType, mRequirements);
    }
  }
}
