...
/** Downloads and installs prediction model bundles into the on-device model store. */
public final class ModelDownloader {
  ...
  public ModelDownloader(@NonNull Context context, @NonNull ModelStore modelStore) {
  ...
  @NonNull
  public ModelDefinition downloadAndInstall(
      @NonNull ModelDefinition definition, @NonNull String bundleUrl, @Nullable String bundleSha256)
    ...
    try {
      ...
      final ModelDefinition manifestDefinition = ModelDefinition.fromJson(readJson(manifestFile));
  ...
  private void validateExtractedFiles(@NonNull File stagingDir, @NonNull ModelDefinition definition)
      throws IOException {
    for (ModelDefinition.FileRequirement requirement :
  ...
  private void ensureWithinDirectory(@NonNull File root, @NonNull File candidate)
      throws IOException {
