...
public class AddonNotificationReceiverStandalone extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        Log.d(TAG, "AddonNotificationReceiverStandalone.onReceive called with action: " + intent.getAction());
        ...
        if ("com.anysoftkeyboard.action.REGISTER_ADDON_NOTIFICATION".equals(intent.getAction())) {
            try {
                ...
                if (packageName != null && setupIntent != null) {
                    ...
                    NotificationDriver notificationDriver = new NotificationDriverImpl(context.getApplicationContext());
                    ...
                    boolean shown = AddonNotificationSystem.showIfNeeded(
                        packageName, 
                        setupIntent, 
                        title, 
                        message
