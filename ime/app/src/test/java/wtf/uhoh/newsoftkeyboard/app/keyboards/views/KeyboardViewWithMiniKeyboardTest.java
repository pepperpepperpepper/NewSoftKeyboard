...
import static wtf.uhoh.newsoftkeyboard.R.xml.keyboard_with_keys_with_no_codes;
...
public class KeyboardViewWithMiniKeyboardTest extends KeyboardViewBaseTest {

  private KeyboardViewWithMiniKeyboard mViewUnderTest;
  ...
  protected void setCreatedKeyboardView(@NonNull KeyboardViewBase view) {
    ...
    mViewUnderTest = (KeyboardViewWithMiniKeyboard) view;
  }

  @Override
  protected KeyboardViewBase createViewToTest(Context context) {
    return new KeyboardViewWithMiniKeyboard(context, null);
  }

  @Test
  public void testPopupShownListener() throws Exception {
    KeyboardViewWithMiniKeyboard.OnPopupShownListener listener =
        Mockito.mock(KeyboardViewWithMiniKeyboard.OnPopupShownListener.class);
  ...
  public void testShortPressWhenNoPrimaryKeyAndNoPopupItemsShouldNotOutput() throws Exception {
    ...
    Assert.assertFalse(mViewUnderTest.mMiniKeyboardPopup.isShowing());
    final KeyboardKey key = (KeyboardKey) anyKeyboard.getKeys().get(3);
  ...
  public void testShortPressWithLabelWhenNoPrimaryKeyAndNoPopupItemsShouldNotOutput()
    ...
    Assert.assertNull(mViewUnderTest.getMiniKeyboard());
    Assert.assertFalse(mViewUnderTest.mMiniKeyboardPopup.isShowing());
    final KeyboardKey key = (KeyboardKey) anyKeyboard.getKeys().get(4);
  ...
  public void testShortPressWhenNoPrimaryKeyAndPopupCharactersShouldShowPopupWindow()
    ...
    final KeyboardKey key = (KeyboardKey) anyKeyboard.getKeys().get(1);
  ...
  public void testShortPressWhenNoPrimaryKeyAndPopupLayoutShouldShowPopupWindow() throws Exception {
    ...
    final KeyboardKey key = (KeyboardKey) anyKeyboard.getKeys().get(0);
  ...
  public void testShortPressWhenNoPrimaryKeyButTextWithoutPopupShouldOutputText() throws Exception {
    ...
    final KeyboardKey key = (KeyboardKey) anyKeyboard.getKeys().get(5);
  ...
  public void testShortPressWhenNoPrimaryKeyButTextWithPopupShouldOutputText() throws Exception {
    ...
    final KeyboardKey key = (KeyboardKey) anyKeyboard.getKeys().get(6);
  ...
  public void
    ...
    final KeyboardKey key = (KeyboardKey) anyKeyboard.getKeys().get(2);
  ...
  public void testLongPressKeyWithPopupCharactersWhileShifted() throws Exception {
    ...
    Assert.assertTrue(mViewUnderTest.mMiniKeyboardPopup.isShowing());
    final KeyboardViewBase miniKeyboardView = mViewUnderTest.getMiniKeyboard();
    final KeyboardDefinition miniKeyboard = miniKeyboardView.getKeyboard();
    Assert.assertNotNull(miniKeyboard);
  ...
  public void testLongPressKeyPressStateWithPopupCharacters() {
    final KeyboardKey key = findKey('w');
    Assert.assertTrue(key.popupCharacters.length() > 0);
