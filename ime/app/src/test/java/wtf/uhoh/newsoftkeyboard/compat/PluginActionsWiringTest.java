...
import wtf.uhoh.newsoftkeyboard.addons.AddOnsFactory.ReceiverSpec;
  ...
  public void extensionKeyboardFactoryContainsBothNamespaces() throws Exception {
    KeyboardExtensionFactory factory =
        new KeyboardExtensionFactory(
            ...
            wtf.uhoh.newsoftkeyboard.R.string.settings_default_ext_kbd_bottom_row_key,
            KeyboardExtensionFactory.BOTTOM_ROW_PREF_ID_PREFIX,
            wtf.uhoh.newsoftkeyboard.app.keyboardextensions.KeyboardExtension.TYPE_BOTTOM);
    List<ReceiverSpec> specs = getReceiverSpecs(factory);
    assertTrue(
        specs.contains(
            new ReceiverSpec(
