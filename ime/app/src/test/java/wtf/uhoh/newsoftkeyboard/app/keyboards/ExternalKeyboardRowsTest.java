...
public class ExternalKeyboardRowsTest {
  ...
  public void testKeyboardRowUrlModeNoneTopRowHasDomain() throws Exception {
    ...
    Keyboard.Key key = TestableImeService.findKeyWithPrimaryKeyCode(KeyCodes.DOMAIN, keyboard);
    ...
    key = TestableImeService.findKeyWithPrimaryKeyCode(KeyCodes.DOMAIN, keyboard);
    Assert.assertNotNull(key);
