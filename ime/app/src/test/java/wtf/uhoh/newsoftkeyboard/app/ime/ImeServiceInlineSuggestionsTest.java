...
public class ImeServiceInlineSuggestionsTest extends ImeServiceBaseTest {
  ...
  public void testActionStripNotAddedIfEmptySuggestions() {
    ...
    Assert.assertFalse(mImeServiceUnderTest.onInlineSuggestionsResponse(mockResponse()));
    Assert.assertNull(
        mImeServiceUnderTest
            .getInputViewContainer()
            .findViewById(R.id.inline_suggestions_strip_root));
  ...
  public void testActionStripAdded() {
    simulateOnStartInputFlow();
    mImeServiceUnderTest.onInlineSuggestionsResponse(
  ...
  public void testCreatesCorrectRequest() {
    simulateOnStartInputFlow();
    var request = mImeServiceUnderTest.onCreateInlineSuggestionsRequest(new Bundle());
  ...
  public void testShowsSuggestionsOnClickAction() {
    ...
    mImeServiceUnderTest.onInlineSuggestionsResponse(mockResponse(inlineView1, inlineView2));
    var rootView =
        mImeServiceUnderTest
            .getInputViewContainer()
            .findViewById(R.id.inline_suggestions_strip_root);
    ...
    Assert.assertNull(
        mImeServiceUnderTest.getInputViewContainer().findViewById(R.id.inline_suggestions_list));
  ...
  public void testPrioritizePinnedSuggestions() {
    ...
    mImeServiceUnderTest.onInlineSuggestionsResponse(response);
    var rootView =
        mImeServiceUnderTest
            .getInputViewContainer()
            .findViewById(R.id.inline_suggestions_strip_root);
  ...
  public void testClosesInlineSuggestionsOnPick() {
    ...
    //        Assert.assertEquals(
    //                View.VISIBLE, ((View)
    // mImeServiceUnderTest.getInputView()).getVisibility());
    //        Assert.assertNull(
    //                mImeServiceUnderTest
    //                        .getInputViewContainer()
