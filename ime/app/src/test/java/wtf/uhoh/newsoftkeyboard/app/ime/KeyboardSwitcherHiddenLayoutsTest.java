...
import wtf.uhoh.newsoftkeyboard.app.testing.TestableImeService.TestableKeyboardSwitcher;
...
public class KeyboardSwitcherHiddenLayoutsTest extends ImeServiceBaseTest {
  ...
  public void testHiddenSymbolsAccessibleByDirectIdOnly() {
    mKeyboardFactory =
        wtf.uhoh.newsoftkeyboard.app.NskApplicationBase.getKeyboardFactory(getApplicationContext());
    ...
    TestableKeyboardSwitcher switcher = mImeServiceUnderTest.getKeyboardSwitcherForTests();
  ...
  private void registerHiddenKeyboard(KeyboardFactory factory, KeyboardAddOnAndBuilder builder) {
    try {
      Field addOnsByIdField =
          wtf.uhoh.newsoftkeyboard.addons.AddOnsFactory.class.getDeclaredField("mAddOnsById");
