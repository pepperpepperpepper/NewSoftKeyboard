...
public class ImeServiceKeyboardSubtypeTest extends ImeServiceBaseTest {
  ...
  public void testSubtypeReported() {
    ...
    Mockito.verify(mImeServiceUnderTest.getInputMethodManager())
  ...
  public void testAvailableSubtypesReported() {
    Mockito.reset(mImeServiceUnderTest.getInputMethodManager());
    ...
    mImeServiceUnderTest.onAvailableKeyboardsChanged(keyboardBuilders);
  ...
  public void testKeyboardSwitchedOnCurrentInputMethodSubtypeChanged() {
    ...
    InputMethodSubtype subtype =
        new InputMethodSubtype.InputMethodSubtypeBuilder()
            ...
            .build();
    mImeServiceUnderTest.simulateCurrentSubtypeChanged(subtype);
    ArgumentCaptor<InputMethodSubtype> subtypeArgumentCaptor =
        ArgumentCaptor.forClass(InputMethodSubtype.class);
    Mockito.verify(mImeServiceUnderTest.getInputMethodManager())
        .setInputMethodAndSubtype(
