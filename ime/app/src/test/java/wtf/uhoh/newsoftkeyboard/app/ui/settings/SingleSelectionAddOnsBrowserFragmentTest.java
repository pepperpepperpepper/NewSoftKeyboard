...
import static wtf.uhoh.newsoftkeyboard.app.keyboards.KeyboardSwitcher.INPUT_MODE_TEXT;
import static wtf.uhoh.newsoftkeyboard.app.testing.TestableImeService.createEditorInfoTextWithSuggestions;
...
public class SingleSelectionAddOnsBrowserFragmentTest
  ...
  public void testDemoKeyboardShowsLastUsedKeyboardAlphabet() {
    ...
    TestableImeService service = Robolectric.setupService(TestableImeService.class);
    service
