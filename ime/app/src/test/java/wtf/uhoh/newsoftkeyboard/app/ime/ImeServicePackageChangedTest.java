...
@Config(shadows = ImeServicePackageChangedTest.ShadowPackageManagerWithXml.class)
public class ImeServicePackageChangedTest {
  ...
  private TestableImeService mSoftKeyboard;

  @Before
  public void setUp() throws Exception {
    mSoftKeyboard = Robolectric.buildService(TestableImeService.class).create().get();
  ...
  public void testAddedPackageWithPackageName() throws Exception {
    ...
    packageInfoWithAddOns.receivers[0].metaData.putInt(
        "wtf.uhoh.newsoftkeyboard.keyboards", R.xml.english_keyboards);
