...
public class MikeRozoffKeyboardSwitchInstrumentedTest {
  ...
  public void setUp() throws Exception {
    ...
    wtf.uhoh.newsoftkeyboard.app.keyboards.KeyboardFactory factoryPostConfig =
  ...
  private void configureMikeRozoffAsDefault() {
    ...
    wtf.uhoh.newsoftkeyboard.app.keyboards.KeyboardAddOnAndBuilder active =
        factory.getEnabledAddOn();
  ...
  private void assertKeyboardActive(String expectedKeyboardId, long timeoutMs) {
    ...
    if (!observed) {
      ...
      if (lastId == null) {
        wtf.uhoh.newsoftkeyboard.app.keyboards.KeyboardAddOnAndBuilder factoryActive =
            NskApplicationBase.getKeyboardFactory(ApplicationProvider.getApplicationContext())
                .getEnabledAddOn();
