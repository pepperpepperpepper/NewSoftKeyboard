...
final class AnyKeyboardViewBaseInitializer {
  ...
  private AnyKeyboardViewBaseInitializer() {
    // no instances
  }

  private static void applySwipeThresholdsSnapshot(
      AnyKeyboardViewBase view, RxSharedPrefs prefs, SwipeThresholdApplier swipeThresholdApplier) {
