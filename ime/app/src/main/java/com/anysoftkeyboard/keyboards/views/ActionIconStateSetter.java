  ...
  void applyState(int keyboardActionType, @Nullable Drawable icon) {
    ...
    switch (keyboardActionType) {
      case EditorInfo.IME_ACTION_DONE ->
          icon.setState(drawableStatesProvider.DRAWABLE_STATE_ACTION_DONE);
      case EditorInfo.IME_ACTION_GO ->
          icon.setState(drawableStatesProvider.DRAWABLE_STATE_ACTION_GO);
      case EditorInfo.IME_ACTION_SEARCH ->
          icon.setState(drawableStatesProvider.DRAWABLE_STATE_ACTION_SEARCH);
      case EditorInfo.IME_ACTION_NONE, EditorInfo.IME_ACTION_UNSPECIFIED ->
          icon.setState(drawableStatesProvider.DRAWABLE_STATE_ACTION_NORMAL);
