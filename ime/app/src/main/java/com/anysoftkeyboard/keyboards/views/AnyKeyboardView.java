        ...
        new ExtensionKeyboardController(
            new ExtensionKeyboardController.Host() {
              ...
              public boolean forwardTouchToSuper(@NonNull MotionEvent motionEvent) {
                return AnyKeyboardView.super.onTouchEvent(motionEvent);
              }

              @Override
              public void forwardCancelToSuper(@NonNull MotionEvent cancelEvent) {
                AnyKeyboardView.super.onTouchEvent(cancelEvent);
              }
              ...
              public void dismissAllKeyPreviews() {
                AnyKeyboardView.this.dismissAllKeyPreviews();
              }
              ...
              public void dismissPopupKeyboard() {
                AnyKeyboardView.this.dismissPopupKeyboard();
              }
              ...
              public boolean showExtensionKeyboardPopup(
                ...
                return AnyKeyboardView.this.onLongPress(
                    extensionKeyboard,
                    popupKey,
                    isSticky,
                    AnyKeyboardView.this.getPointerTracker(motionEvent));
              }

              @Override
              public void showUtilityKeyboardPopup(@NonNull Keyboard.Key popupKey) {
                AnyKeyboardView.this.showMiniKeyboardForPopupKey(mDefaultAddOn, popupKey, true);
              }

              @Nullable
              @Override
              public AnyKeyboard keyboard() {
                return getKeyboard();
              }
            },
            mDisposables,
