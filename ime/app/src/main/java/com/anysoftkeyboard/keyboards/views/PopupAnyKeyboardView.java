...
public class PopupAnyKeyboardView extends AnyKeyboardViewBase {
  public PopupAnyKeyboardView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public PopupAnyKeyboardView(Context context, AttributeSet attrs, int defStyle) {
