...
public final class BackWordDeleter {

  private BackWordDeleter() {}

  public static void handleBackWord(
    ...
    CharSequence beforeCursor = inputConnectionRouter.getTextBeforeCursor(128, 0);
    ...
    inputConnectionRouter.deleteSurroundingText(inputLength - idx, 0); // it is always > 0 !
  }
