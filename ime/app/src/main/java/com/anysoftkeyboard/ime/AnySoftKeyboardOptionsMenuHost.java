...
public final class AnySoftKeyboardOptionsMenuHost implements OptionsMenuLauncher.Host {

  @NonNull private final AnySoftKeyboard ime;

  public AnySoftKeyboardOptionsMenuHost(@NonNull AnySoftKeyboard ime) {
    this.ime = ime;
  }
  ...
  public void launchDictionaryOverriding() {
    DictionaryOverrideDialog.show(new AnySoftKeyboardDictionaryOverrideDialogHost(ime));
  }
