...
public final class AnySoftKeyboardLanguageSelectionDialogHost
    implements LanguageSelectionDialog.Host {

  @NonNull private final AnySoftKeyboard ime;

  public AnySoftKeyboardLanguageSelectionDialogHost(@NonNull AnySoftKeyboard ime) {
    this.ime = ime;
  }
