...
public final class AnySoftKeyboardFunctionKeyHost implements FunctionKeyHandler.Host {
  ...
  public AnySoftKeyboardFunctionKeyHost(
  ...
  public String getDefaultDictionaryLocale() {
    final AnyKeyboard keyboard = currentAlphabetKeyboard.get();
