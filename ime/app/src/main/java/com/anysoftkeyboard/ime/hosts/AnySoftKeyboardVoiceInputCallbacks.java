...
public final class AnySoftKeyboardVoiceInputCallbacks implements VoiceImeController.HostCallbacks {
  ...
  public AnySoftKeyboardVoiceInputCallbacks(
      @NonNull Context context, @NonNull Callbacks callbacks) {
