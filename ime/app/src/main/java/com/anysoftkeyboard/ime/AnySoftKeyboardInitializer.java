...
import com.anysoftkeyboard.ime.hosts.AnySoftKeyboardInputViewLifecycleHost;
import com.anysoftkeyboard.ime.hosts.AnySoftKeyboardModifierKeyStateHost;
import com.anysoftkeyboard.ime.hosts.AnySoftKeyboardVoiceInputCallbacks;
...
public final class AnySoftKeyboardInitializer {
  ...
  public static Result initialize(
      @NonNull AnySoftKeyboard service,
      @NonNull InputMethodManager baseInputMethodManager,
      @NonNull Consumer<com.anysoftkeyboard.keyboards.AnyKeyboard> setKeyboardForView,
      @NonNull java.util.function.BooleanSupplier handleCloseRequest,
      @NonNull AnySoftKeyboardModifierKeyStateHost.Actions modifierKeyStateActions,
      @NonNull AnySoftKeyboardFunctionKeyHost.ImeActions functionKeyImeActions,
    ...
    final ModifierKeyStateHandler modifierKeyStateHandler =
        new ModifierKeyStateHandler(
            new AnySoftKeyboardModifierKeyStateHost(modifierKeyStateActions),
    ...
    final VoiceImeController voiceImeController =
        new VoiceImeController(
            ...
            new AnySoftKeyboardVoiceInputCallbacks(
                service,
                new AnySoftKeyboardVoiceInputCallbacks.Callbacks(
    ...
    final InputViewLifecycleHandler inputViewLifecycleHandler =
        new InputViewLifecycleHandler(
            new AnySoftKeyboardInputViewLifecycleHost(
    ...
    final FunctionKeyHandler.Host functionKeyHandlerHost =
        new AnySoftKeyboardFunctionKeyHost(
