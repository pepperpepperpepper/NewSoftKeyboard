        ...
        .map(
            locale ->
                new Pair<>(
                    ...
                    new WordsSQLiteConnection(mContext, mDatabaseFilename, locale)))
        .blockingSubscribe(
            pair ->
            ...
            prefItem ->
                new Pair<>(
                    new WordsSQLiteConnection(
                        mContext, mDatabaseFilename, prefItem.getValue("locale")),
        ...
        .blockingSubscribe(
            pair ->
                pair.second.blockingSubscribe(
                    prefItem -> {
                      pair.first.addWord(
                          prefItem.getValue("word"), Integer.parseInt(prefItem.getValue("freq")));
                    }));
  }
}
