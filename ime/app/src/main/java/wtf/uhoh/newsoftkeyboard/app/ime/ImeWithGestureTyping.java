...
import wtf.uhoh.newsoftkeyboard.app.ime.gesturetyping.ClearGestureStripActionProvider;
import wtf.uhoh.newsoftkeyboard.app.ime.gesturetyping.GestureTypingController;
  ...
  private GestureTypingController.Host getGestureTypingHost() {
    ...
    gestureTypingHost =
        new GestureTypingController.Host() {
          ...
          @Override
          public @NonNull wtf.uhoh.newsoftkeyboard.prefs.RxSharedPrefs prefs() {
          ...
          @Override
          public @Nullable wtf.uhoh.newsoftkeyboard.app.keyboards.views.KeyboardViewContainerView
              inputViewContainer() {
          ...
          @Override
          public @NonNull wtf.uhoh.newsoftkeyboard.utils.ModifierKeyState shiftKeyState() {
