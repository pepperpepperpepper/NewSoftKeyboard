...
final class HintStyleAttributeSetter {
  ...
  static boolean apply(
    ...
    switch (localAttrId) {
      case wtf.uhoh.newsoftkeyboard.R.attr.hintTextSize -> {
