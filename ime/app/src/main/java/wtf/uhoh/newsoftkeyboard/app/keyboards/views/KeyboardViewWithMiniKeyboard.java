...
/**
 * Supports popup keyboard when {@link wtf.uhoh.newsoftkeyboard.app.keyboards.KeyboardKey} says it
 * has that, and user long-press that key.
 */
@SuppressWarnings("this-escape")
public class KeyboardViewWithMiniKeyboard extends SizeSensitiveKeyboardView {

  public interface OnPopupShownListener {
    void onPopupKeyboardShowingChanged(boolean showing);
  }

  private KeyboardViewBase mMiniKeyboard = null;
  ...
  public KeyboardViewWithMiniKeyboard(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public KeyboardViewWithMiniKeyboard(Context context, AttributeSet attrs, int defStyle) {
  ...
  protected final KeyboardViewBase getMiniKeyboard() {
