...
final class KeyTextAttributeSetter {
  ...
  static boolean apply(
    ...
    switch (localAttrId) {
      case wtf.uhoh.newsoftkeyboard.R.attr.keyTextSize -> {
      ...
      case wtf.uhoh.newsoftkeyboard.R.attr.labelTextSize -> {
        int size = remoteTypedArray.getDimensionPixelSize(remoteTypedArrayIndex, -1);
        if (size == -1) return false;
        setLabelTextSize.accept(Math.round(size * keysHeightFactor));
        return true;
      }
      case wtf.uhoh.newsoftkeyboard.R.attr.keyboardNameTextSize -> {
        int size = remoteTypedArray.getDimensionPixelSize(remoteTypedArrayIndex, -1);
        if (size == -1) return false;
        setKeyboardNameTextSize.accept(Math.round(size * keysHeightFactor));
        return true;
      }
      case wtf.uhoh.newsoftkeyboard.R.attr.keyTextColor -> {
      ...
      case wtf.uhoh.newsoftkeyboard.R.attr.keyboardNameTextColor -> {
