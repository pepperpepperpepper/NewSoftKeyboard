...
final class DotsDrawable extends Drawable {
  ...
  @NonNull
  private static android.graphics.BitmapShader createDotsShader() {
    final Bitmap bitmap = getDotsBitmap();
  ...
  private static Bitmap getDotsBitmap() {
    ...
    synchronized (DotsDrawable.class) {
      if (cachedDotsBitmap != null && !cachedDotsBitmap.isRecycled()) return cachedDotsBitmap;
