...
public class KeyboardCondenser {
  ...
  public KeyboardCondenser(Context hostAppContext, KeyboardDefinition keyboard) {
    mKeyboard = keyboard;
    mCondensingFullFactor =
        ((float) hostAppContext.getResources().getInteger(R.integer.condensing_precentage)) / 100f;
    mCondensingEdgeFactor =
        ((float) hostAppContext.getResources().getInteger(R.integer.condensing_precentage_edge))
            / 100f;
  }
