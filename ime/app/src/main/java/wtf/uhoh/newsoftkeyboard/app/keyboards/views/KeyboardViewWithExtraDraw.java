...
public abstract class KeyboardViewWithExtraDraw extends KeyboardViewWithMiniKeyboard {
  private final List<ExtraDraw> mExtraDraws = new ArrayList<>();

  private AnimationsLevel mCurrentAnimationLevel;

  protected KeyboardViewWithExtraDraw(Context context, AttributeSet attrs, int defStyle) {
