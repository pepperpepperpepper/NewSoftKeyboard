...
public abstract class ImePopText extends ImePowerSaving {
  ...
  private void popText(CharSequence textToPop) {
    ...
    if (lastKey != null && inputView instanceof KeyboardViewWithExtraDraw) {
      ...
      mLastTextPop =
          new PopTextExtraDraw.PopOut(
              ...
              lastKey.y - keyboardViewWithExtraDraw.getHeight() / 2);
      keyboardViewWithExtraDraw.addExtraDraw(mLastTextPop);
    }
  }
  ...
  private void revertLastPopText() {
    ...
    if (lastTextPop != null && !lastTextPop.isDone()) {
      ...
      if (inputView instanceof KeyboardViewWithExtraDraw) {
        ((KeyboardViewWithExtraDraw) inputView).addExtraDraw(lastTextPop.generateRevert());
      }
