...
public final class KeyboardSwitchHandlerHost implements KeyboardSwitchHandler.Host {
  ...
  private final BiConsumer<EditorInfo, KeyboardSwitcher.NextKeyboardType> nextKeyboard;
  ...
  public KeyboardSwitchHandlerHost(
      ...
      @NonNull BiConsumer<EditorInfo, KeyboardSwitcher.NextKeyboardType> nextKeyboard,
