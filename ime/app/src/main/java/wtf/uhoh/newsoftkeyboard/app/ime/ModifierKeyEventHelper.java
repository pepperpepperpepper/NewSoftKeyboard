 ...
 * wtf.uhoh.newsoftkeyboard.app.ime.ImeServiceBase} slimmer. This class is a thin, testable utility
 * with no state; it performs the ASCII-to-KeyEvent mapping and dispatches the resulting key events
 * through the provided callbacks/InputConnection.
 */
