...
public interface OnKeyboardActionListener {
  ...
  /**
   * Called when the user presses a key. This is sent before the {@link #onKey} is called. For keys
   * that repeat, this is only called once.
   *
  ...
  /**
   * Called when the user releases a key. This is sent after the {@link #onKey} is called. For keys
   * that repeat, this is only called once.
   *
  ...
  /**
   * Sends a sequence of characters to the listener as a complete text. Does not support suggestions
   *
