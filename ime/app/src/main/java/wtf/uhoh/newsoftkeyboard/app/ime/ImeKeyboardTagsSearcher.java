...
public abstract class ImeKeyboardTagsSearcher extends ImeInlineSuggestions {
    ...
    setTagsSearcher(
        new TagsExtractorImpl(
            ...
            extractKeysListListFromEnabledQuickText(
                NskApplicationBase.getQuickTextKeyFactory(this).getEnabledAddOns()),
  ...
  private static class NoOpKeyboard extends Keyboard {
    ...
    private NoOpKeyboard(
      ...
      super(keyboardAddOn, hostAppContext, xmlLayoutResId);
