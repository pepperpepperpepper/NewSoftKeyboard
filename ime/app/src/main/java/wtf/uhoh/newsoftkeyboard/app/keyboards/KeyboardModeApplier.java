 ...
 * show.
 *
 * <p>This is intentionally narrow and owned by {@code wtf.uhoh.newsoftkeyboard.app.keyboards}: it
 * holds the algorithmic branching of {@link KeyboardSwitcher#setKeyboardMode(int, EditorInfo,
 * boolean)} so the switcher can remain a host/wiring class.
 */
