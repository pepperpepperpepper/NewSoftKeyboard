...
public final class CandidateMerger {
  ...
  /**
   * Adds up to {@code limit} items from {@code additions} into {@code holder}, skipping items
   * already present (using {@code Collection#contains}). Returns the number of items actually
   * added.
   */
