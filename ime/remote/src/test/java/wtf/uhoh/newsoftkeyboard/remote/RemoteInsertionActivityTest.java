...
public class RemoteInsertionActivityTest {
  ...
  public void testDoesNotRequestOnRecreate() {
    ...
    outState.putStringArray(
        MediaInsertion.INTENT_MEDIA_INSERTION_REQUEST_MEDIA_MIMES_KEY, new String[] {"image/png"});
  ...
  public void testStoreDataInBundleOnSaveState() {
    ...
    Assert.assertEquals(
        123, out.getInt(MediaInsertion.INTENT_MEDIA_INSERTION_REQUEST_MEDIA_REQUEST_ID_KEY));
