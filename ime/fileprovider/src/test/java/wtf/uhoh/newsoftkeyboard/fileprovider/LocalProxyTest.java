package wtf.uhoh.newsoftkeyboard.fileprovider;
...
public class LocalProxyTest {
  ...
  public void setup() throws IOException {
    ...
    providerInfo.authority = mAuthority;
  ...
  public void testHappyPathKnownMime() throws IOException {
    ...
    Assert.assertEquals(mAuthority, localUri.getAuthority());
    Assert.assertTrue(
        localUri.getPath() + " should have a different value!",
        localUri.getPath().endsWith(mAuthority + "-dataDir/files/media/file.png.png"));
  ...
  public void testHappyPathUnknownMime() throws IOException {
    ...
    Assert.assertEquals("content", localUri.getScheme());
    Assert.assertEquals(mAuthority, localUri.getAuthority());
    Assert.assertTrue(localUri.getPath().endsWith(mAuthority + "-dataDir/files/media/file.png"));
