...
package wtf.uhoh.newsoftkeyboard.dictionaries.jni;
...
import wtf.uhoh.newsoftkeyboard.base.utils.GCUtils;
...
public class ResourceBinaryDictionary extends Dictionary {
  ...
  public ResourceBinaryDictionary(
    ...
    CompatUtils.loadNativeLibrary(originPackageContext, "newsoftkeyboard_jnidictionaryv2", "1.0.3");
