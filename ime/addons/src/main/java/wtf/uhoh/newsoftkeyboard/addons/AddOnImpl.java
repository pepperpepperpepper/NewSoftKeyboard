...
public abstract class AddOnImpl implements AddOn {
  ...
  protected AddOnImpl(
    ...
    mIsLocalAddOn = hostAppContext.getPackageName().equals(packageContext.getPackageName());
  ...
  public final Context getPackageContext() {
    if (mIsLocalAddOn) return mHostAppContext;
      ...
      try {
        c =
            mHostAppContext
                ...
                .createConfigurationContext(mHostAppContext.getResources().getConfiguration());
  ...
  public void setNewConfiguration(@NonNull Configuration newConfiguration) {
    mHostAppContext = mHostAppContext.createConfigurationContext(newConfiguration);
    ...
    public int[] getRemoteStyleableArrayFromLocal(int[] localStyleableArray) {
      ...
      int[] remoteAttrIds =
          Support.createBackwardCompatibleStyleable(
              localStyleableArray, addOn.mHostAppContext, remoteContext, mAttributesMapping);
