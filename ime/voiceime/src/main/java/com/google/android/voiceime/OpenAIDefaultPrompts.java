...
public class OpenAIDefaultPrompts {
  ...
  /**
   * Default prompt for Whisper-1 model. Provides example of proper capitalization and dialogue
   * formatting.
   */
  public static final String WHISPER_PROMPT =
      "She said, \"Hello, how are you?\" Then she asked, \"What's your name?\" I replied, \"My name"
          + " is John.\"";

  /**
   * Default prompt for GPT-4o model in dictation mode. Provides comprehensive instructions for
   * punctuation conversion and formatting.
   */
  public static final String GPT4_DICTATION_PROMPT =
      "Please transcribe in dictation mode. When the speaker says punctuation commands, convert"
          + " them to actual punctuation:\n"
  ...
  public static String getDefaultPrompt(String model, PromptType promptType) {
    ...
    if ((promptType == PromptType.WHISPER && "whisper-1".equals(model))
        || (promptType == PromptType.GPT4_DICTATION
            && model != null
   ...
   */
  public static String combinePrompts(
      String defaultPrompt, String customPrompt, boolean appendCustom) {
