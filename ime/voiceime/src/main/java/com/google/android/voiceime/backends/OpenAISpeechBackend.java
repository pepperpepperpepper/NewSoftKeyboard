  ...
  public void startTranscription(
    ...
    String responseFormat =
        sanitizeResponseFormat(
            prefs.getString(
                context.getString(R.string.settings_key_openai_response_format), "text"));
    String chunkingStrategy =
        sanitizeChunkingStrategy(
            prefs.getString(
                context.getString(R.string.settings_key_openai_chunking_strategy), "none"),
            model);
    String prompt = prefs.getString(context.getString(R.string.settings_key_openai_prompt), "");

    boolean addTrailingSpace =
        prefs.getBoolean(context.getString(R.string.settings_key_openai_add_trailing_space), true);
    boolean useDefaultPrompt =
        prefs.getBoolean(context.getString(R.string.settings_key_openai_use_default_prompt), false);
    String defaultPromptType =
        prefs.getString(
            context.getString(R.string.settings_key_openai_default_prompt_type), "whisper");
