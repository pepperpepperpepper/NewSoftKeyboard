 ...
 * TypedSuggestionsReportUiAutomatorTest into a template HTML file.
 *
 * Usage:
 *   node scripts/render_typed_suggestions_report.js <template.html> <report.json> <out.html>
 */
...
function usage() {
  ...
  console.error('Usage: node scripts/render_typed_suggestions_report.js <template.html> <report.json> <out.html>');
  process.exit(2);
}
